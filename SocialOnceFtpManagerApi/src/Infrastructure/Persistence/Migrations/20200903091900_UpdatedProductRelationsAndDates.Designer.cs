...
namespace EAProductService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20200903091900_UpdatedProductRelationsAndDates")]
    partial class UpdatedProductRelationsAndDates
    {
            ...
            modelBuilder.Entity("EAProductService.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<DateTime>("LastPhysInvtDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("LastUnitCostCalcDate")
                        .HasColumnType("datetime2");
